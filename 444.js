...
if(usePairingCode && !finix444.authState.creds.registered) {
		const phoneNumber = await question(`𝚌𝚛𝚊𝚌𝚔𝚎𝚍 𝚋𝚢 𝙹𝙰𝙲𝙺 - Contoh Masukkan Nomor : 6285947535179 𝚜𝚑𝚊𝚛𝚎𝚍 𝚋𝚢 PenulisCodex
Masukkan Nomor Bot Anda Mang:`);
		const code = await finix444.requestPairingCode(phoneNumber.trim())
		console.log(`INI CODENYA BOSKUU : ${code}`)
}
